...
const AccueilHero = () => {
  return (
    <div className="w-full max-w-[1450px] relative mx-auto">
      <div className=" px-6 lg:px-8 pb-5 rounded-lg lg:flex lg:flex-col">
        <img
          src="/img/background/accueil.png"
          className="lg:max-h-[700px] max-h-[1000px] w-full object-cover rounded-lg relative z-10"
        />
        <div
          className="lg:bg-beige lg:absolute z-20 bottom-7 lg:bottom-10 lg:left-16 lg:flex flex-col lg:w-4/12 w-10/12 py-10 pl-6 "
